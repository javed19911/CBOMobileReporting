...
public class vmPhyStock extends CBOViewModel<iPhyStock> {
    ...
    @Override
    public void onUpdateView(AppCompatActivity context, iPhyStock view) {
    ...
    public void getOrderItem(final AppCompatActivity context, Boolean SyncYN){
        ...
        if (SyncYN) {
            ...
            new MyOrderAPIService(context).execute(new ResponseBuilder("OP_ITEMGRID_MOBILE", request)
                    .setTables(tables)
                    .setMultiTable(true)
