...
import bill.stockEntry.AddRemark;
...
public class FPhyCart extends Fragment implements IFCompanycart {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate (R.layout.fragment__fphycart_view, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        cartAdapter = new aPhyStock (context, viewModel.getOrder ());
