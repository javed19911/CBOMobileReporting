...
public class DOB_DOA_emp_Adapter extends BaseAdapter {
  ...
  Context context;
    ...
    public DOB_DOA_emp_Adapter(Context context, ArrayList<Map<String, String>> data){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = layoutInflater.inflate(R.layout.dob_doa_emp,null);
        ...
        if(dataList.get(position).get("PA_NAME").equals("No Data Found")) {
        ...
        holder.name.setText(dataList.get(position).get("PA_NAME"));
        ...
        holder.call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new MyCustomMethod(context).CallDilog(dataList.get(position).get("MOBILE").split(",")[0],dataList.get(position).get("PA_NAME"));
            }
        });
        ...
        holder.msg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new MyCustomMethod(context).sendSMS(dataList.get(position).get("MOBILE").split(",")[0],dataList.get(position).get("PA_NAME"));
            }
        });
