...
public class DraftMail_Adapter extends BaseAdapter {
  ...
  Context context;
    ...
    public DraftMail_Adapter(Context context, ArrayList<Map<String,String>> data){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = layoutInflater.inflate(R.layout.draft_row,null);
        ...
        if (dataList.get(position).get("from").equals("")){
        ...
        holder.cir.setText(  holder.from.getText().toString().substring(0,1).toUpperCase());
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("mail_id",dataList.get(position).get("id"));
                intent.putExtra("mail_type","X");
