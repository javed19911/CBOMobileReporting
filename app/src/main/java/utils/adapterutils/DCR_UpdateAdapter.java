...
public class DCR_UpdateAdapter extends ArrayAdapter<Dcr_Workwith_Model>
{
    ...
    {        
    	...
    	{            
    		...
    		view = inflator.inflate(R.layout.dcr_update_row, null); 

    		final ViewHolder viewHolder = new ViewHolder(); 
    		viewHolder.text = (TextView) view.findViewById(R.id.dcr_workwith_name_update); 	    		
    		viewHolder.id=(TextView) view.findViewById(R.id.dcr_workwith_id_update);
    	
    		viewHolder.checkbox = (CheckBox) view.findViewById(R.id.workwith_select_update); 
