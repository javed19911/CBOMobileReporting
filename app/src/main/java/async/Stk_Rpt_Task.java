 ...
 */
public class Stk_Rpt_Task extends AsyncTask<String,String,String> {
    ...
    public Stk_Rpt_Task(AppCompatActivity context){
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            response = serviceHandler.getResponse_STOCKIST_VIEW(db_helper.getCompanyCode(), "" + CBOReportView.lastPaId, params[0]);
