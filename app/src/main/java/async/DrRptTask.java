 ...
 */
public class DrRptTask extends AsyncTask<String,String,String > {
    private ServiceHandler serviceHandler;
    public Context context;
    private TaskListener<String> mListener;
    CBO_DB_Helper cboDbHelper;

    public DrRptTask(AppCompatActivity context){
    ...
    protected String doInBackground(String... params) {
       ...
       String response = null;
        try {
            ...
            response = serviceHandler.getResponse_DOCTOR_VIEW(cboDbHelper.getCompanyCode(), "" + CBOReportView.lastPaId, params[0], params[1]);
