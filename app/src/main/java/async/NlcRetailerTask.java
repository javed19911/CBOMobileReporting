 ...
 */
public class NlcRetailerTask extends AsyncTask<String,String,String > {
    private ServiceHandler serviceHandler;
    public Context context;
    private TaskListener<String> mListener;
    CBO_DB_Helper cboDbHelper;

    public NlcRetailerTask(AppCompatActivity context){
    ...
    protected String doInBackground(String... params) {
       ...
       String response = null;
        try {
            ...
            response = serviceHandler.getResponse_NLCRETAILER_VIEW(cboDbHelper.getCompanyCode(), "" + CBOReportView.lastPaId, params[0]);
