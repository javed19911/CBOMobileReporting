 ...
 */
public class SpoHeadquarterWise extends AppCompatActivity {
   ...
   TextView consigneeText,stk_txt;
    ...
    //    boolean customTitleSupported = requestWindowFeature(Window.FEATURE_CUSTOM_TITLE);
      ...
      setContentView(R.layout.zoomer_layout);
        ...
        textView.setText("SPO Hedquarter Wise Report");
       ...
       /* if (customTitleSupported){
        ...
        if (titleText !=null ){
            titleText.setText("SPO Details Headquarter Wise");
        }*/

        context = SpoHeadquarterWise.this;
        ...
        stk_txt.setText("");
        consigneeText.setText("Headquator");
...
*/
                    ...
                    data1.put("Headquator",Consignee);
...
*/
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.share) {
            myConnection.create_xml(data1,"SPO Hedquarter Wise Report");
        }else{
            SpoRptAdapter.clickCount= -- SpoRptAdapter.clickCount;
            finish();
        }
