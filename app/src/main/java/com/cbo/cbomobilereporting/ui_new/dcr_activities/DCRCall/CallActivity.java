...
public  class CallActivity extends CustomActivity implements ExpandableListAdapter.Summary_interface, ICall {

    vmCall vmChemistReminder;
    mChemistRc chemist;
    TextView hader_text;
    ...
    public void getRefrenceByid() {
        FlurryAgent.logEvent("CallActivity");
    ...
    public void openCustomerList(ArrayList<SpinnerModel> chemist) {
        Intent intent = new Intent(context, com.cbo.cbomobilereporting.ui_new.dcr_activities.CallUtils.CallActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vmChemistReminder = ViewModelProviders.of(this).get(vmCall.class);
        vmChemistReminder.setListener(context,this);
        //ask here
        vmChemistReminder.setView(context,this);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MESSAGE_INTERNET_SEND_FCM:
                    if (networkUtil.internetConneted(CallActivity.this)){
    ...
    @Override
    public void setChemistName(mChemistRc chemist) {
        drname.setText(chemist.getName());
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            ...
            case CALL_ACTIVITY:
               ...
               vmChemistReminder .setCallmodel(context,(SpinnerModel) data.getSerializableExtra("item"));
        }
